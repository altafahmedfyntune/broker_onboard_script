...
from request import get_data, downloadFile
...
if downloaded:
    ...
    pprint(backend_env)
    run_command('git clone https://github.com/Fyntune/motor_2.0_backend.git')
    setup_backend('backend_env.txt', '.env', backend_env)
    run_command('git clone https://github.com/Fyntune/motor_2.0_frontend.git')
    ...
    pprint(ckyc_env)
    run_command('git clone https://github.com/Fyntune/ckyc-api.git')
